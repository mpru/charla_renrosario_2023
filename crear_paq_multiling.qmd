...
## ¿Por qué consideraríamos crear un paquete en otro idioma que no sea inglés?^[Algunas ideas son tomadas de [acá](https://ropensci.org/blog/2023/01/12/multilingual-publishing-en/)]
...
-   Tanto los nombres de las funciones, como los mensajes emitidos y las páginas de ayuda están disponibles en los lenguajes implementados[^1].

[^1]: Para ver las páginas de ayuda, tenemos que completar las documentaciones que dejamos pendiente y hacer una instalación de nuestro paquete en desarrollo con `install()`
