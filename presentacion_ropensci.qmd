...
::: {style="font-size: .8em"}
-   Creando una infraestructura técnica de herramientas de software en R cuidadosamente revisadas, que reduzcan las barreras para trabajar con fuentes de datos científicos.
...
::: columns
::: {.column width="70%"}
-   Proceso de revisión de paquetes de R transparente, constructivo, no conflictivo, estandarizado y abierto.
...
-   [**Sistema R-Universe**](https://r-universe.dev/search/): proyecto para mejorar la publicación y el descubrimiento de software de investigación en R.
...
# Programa Champions {background="#43464B"}
...
-   diversa de personas,
-   que colaboren en aspectos de la creación de software de investigación,
-   que sean "líderes" de la comunidad,
-   y que se esfuercen por transformar el ecosistema para mejor.

## Participantes

Está pensando para que participen personas:

  - que pertenecen a grupos histórica y sistemáticamente excluidos.
  - interesadas en contribuir a rOpenSci y al ecosistema más amplio de comunidades de software de código abierto y de investigación.
